...
class nouveau_vacataire extends StatefulWidget {
  const nouveau_vacataire({Key? key}) : super(key: key);

  @override
  _nouveau_etudiantState createState() => _nouveau_etudiantState();
}
  

class _nouveau_etudiantState extends State<nouveau_vacataire> {
  //Future<void> computeFuture = Future.value();
  Vacataire vacataire = Vacataire("0","");

  final _formKey = GlobalKey<FormState>();

  //bddController dbController = bddController();
